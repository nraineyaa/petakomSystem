                                    ...
                                    <form enctype="multipart/form-data" method="POST" id="updateUser">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="password" type="password" class="form-control" name="password" value="{{$register->password}}" readonly>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="confirmPass">{{ __('Confirm Password') }}</label>
                                                <input id="confirmPass" type="password" class="form-control" name="confirmPass" value="{{$register->confirmPass}}" readonly>
                                            </div>
                                        </div>
