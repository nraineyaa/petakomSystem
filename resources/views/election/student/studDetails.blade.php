...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <center>
                <h2><strong>ELECTION CANDIDATE DETAILS</strong></h2>
            </center>
            <center>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <center><button style="width:70%; background-color:forestgreen; color:aliceblue">Vote this Candidate</button></center><br>
