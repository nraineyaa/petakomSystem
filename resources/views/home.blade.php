...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="bootstrap1/bootstrap1/assets/images/favicon.svg" type="image/svg" />
...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">
                            <img src="bootstrap1/bootstrap1/assets/images/logo/logo.svg" alt="Logo" />
                        </a>
                        ...
                        <div class="navbar-collapse">
                            <ul id="nav" class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Activities">Activities</a>
                                </li>
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Calendar">Calendar</a>
                                </li>
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Proposal">Proposal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Report">Report</a>
                                </li>
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Election">Election</a>
                                </li>
                                <li class="nav-item">
                                    <a class="ud-menu-scroll" href="#Bulletin">Bulletin</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ud-hero-brands-wrapper wow fadeInUp" data-wow-delay=".3s">
                        <img src="bootstrap1/bootstrap1/assets/images/hero/brand.svg" alt="brand" />
                    </div>
                    <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
                        <img src="bootstrap1/bootstrap1/assets/images/hero/hero-image.svg" alt="hero-image" />
                        <img src="bootstrap1/bootstrap1/assets/images/hero/dotted-shape.svg" alt="shape" class="shape shape-1" />
                        <img src="bootstrap1/bootstrap1/assets/images/hero/dotted-shape.svg" alt="shape" class="shape shape-2" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="ud-about-image">
                    <img src="bootstrap1/bootstrap1/assets/images/about/about-image.svg" alt="about-image" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="faq" class="ud-faq">
        <div class="shape">
            <img src="bootstrap1/assets/images/faq/shape.svg" alt="shape" />
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                    ...
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="bootstrap1/assets/images/testimonials/author-01.png" alt="author" />
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".15s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="bootstrap1/assets/images/testimonials/author-02.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>Margin Gesmu</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-testimonial-info">
                            <div class="ud-testimonial-image">
                                <img src="bootstrap1/assets/images/testimonials/author-03.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4>William Smith</h4>
                    ...
                    <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="ud-brands-logo">
                            <div class="ud-single-logo">
                                <img src="bootstrap1/assets/images/brands/ayroui.svg" alt="ayroui" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="bootstrap1/assets/images/brands/uideck.svg" alt="uideck" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="bootstrap1/assets/images/brands/graygrids.svg" alt="graygrids" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="bootstrap1/assets/images/brands/lineicons.svg" alt="lineicons" />
                            </div>
                            <div class="ud-single-logo">
                                <img src="bootstrap1/assets/images/brands/ecommerce-html.svg" alt="ecommerce-html" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="bootstrap1/assets/images/team/team-01.png" alt="team" />
                            </div>

                            <img src="bootstrap1/assets/images/team/dotted-shape.svg" alt="shape" class="shape shape-1" />
                            <img src="bootstrap1/assets/images/team/shape-2.svg" alt="shape" class="shape shape-2" />
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".15s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="bootstrap1/assets/images/team/team-02.png" alt="team" />
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".2s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="bootstrap1/assets/images/team/team-03.png" alt="team" />
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="ud-single-team wow fadeInUp" data-wow-delay=".25s">
                        <div class="ud-team-image-wrapper">
                            <div class="ud-team-image">
                                <img src="bootstrap1/assets/images/team/team-04.png" alt="team" />
                            </div>
    ...
    <footer class="ud-footer wow fadeInUp" data-wow-delay=".15s">
        <div class="shape shape-1">
            <img src="bootstrap1/assets/images/footer/shape-1.svg" alt="shape" />
        </div>
        <div class="shape shape-2">
            <img src="bootstrap1/assets/images/footer/shape-2.svg" alt="shape" />
        </div>
        <div class="shape shape-3">
            <img src="bootstrap1/assets/images/footer/shape-3.svg" alt="shape" />
        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="ud-widget">
                            <a href="index.html" class="ud-footer-logo">
                                <img src="bootstrap1/assets/images/logo/logo.svg" alt="logo" />
                            </a>
                            ...
                            <ul class="ud-widget-brands">
                                <li>
                                    <a href="https://ayroui.com/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/ayroui.svg" alt="ayroui" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://ecommercehtml.com/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/ecommerce-html.svg" alt="ecommerce-html" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://graygrids.com/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/graygrids.svg" alt="graygrids" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://lineicons.com/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/lineicons.svg" alt="lineicons" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://uideck.com/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/uideck.svg" alt="uideck" />
                                    </a>
                                </li>
                                <li>
                                    <a href="https://tailwindtemplates.co/" rel="nofollow noopner" target="_blank">
                                        <img src="bootstrap1/assets/images/footer/brands/tailwindtemplates.svg" alt="tailwindtemplates" />
                                    </a>
                                </li>
                            </ul>
                        </div>
